...
AntColonyBase::AntColonyBase(Graph &graph, size_t count_colony, size_t size_colony)
...
void AntColonyBase::UpdateMinPath(TsmResult &min_path, const TsmResult &path) const {
