#ifndef PARALLELS_SOURCE_ANT_COLONY_MODEL_ANT_COLONY_BASE_H_
#define PARALLELS_SOURCE_ANT_COLONY_MODEL_ANT_COLONY_BASE_H_
...
#endif  // PARALLELS_SOURCE_ANT_COLONY_MODEL_ANT_COLONY_BASE_H_