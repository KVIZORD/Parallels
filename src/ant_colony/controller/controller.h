#ifndef PARALLELS_SOURCE_ANT_COLONY_CONTROLLER_CONTROLLER_H_
#define PARALLELS_SOURCE_ANT_COLONY_CONTROLLER_CONTROLLER_H_
...
#endif  // PARALLELS_SOURCE_ANT_COLONY_CONTROLLER_CONTROLLER_H_